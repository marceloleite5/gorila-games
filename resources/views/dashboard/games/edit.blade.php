...
@section('content')
    ...
    <div class="table-responsive">
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <div class="col-lg-7">
                    <div class="text-center"> <h1 class="h3 mb-0 text-gray-800"><b>Modificar Game<br><br></b></h1></div>
                    <div class="">
<form action="/dashboard/games/update/{{ $games->id}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control form-control-user" name="data" id="data" value="{{ $games->data }}">
        </div>
        <hr>
