...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <!-- Form de busca ##############################-->
                        <form action="/dashboard/games" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        ...
                        @endif
                        <!-- Fim da busca ###############################-->
                        <a href="{{ url('/dashboard/games/create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">

                            <i class="fas fa-download fa-sm text-white-50"></i> Novo Game</a>

                    </div>
                   <div class="text-center"> <h1 class="h3 mb-0 text-gray-800"><b>Games<br><br></b></h1></div>

                    <!-- Tabela ############ -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Todos os Games</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$game->arquivo}}</td>
                                            <td>
                                                <img src="/img/game/{{ $game->imagem}}" width="50px" class="img-fluid" alt="{{ $game->nome }}">
                                            </td>
                                            <td>
                                                <a href="{{ url("/dashboard/games/edit/$game->id")}}" class="btn btn-info edit-btn"><ion-icon name="create-outline"></ion-icon>
                                                    Editar</a>
                                            </td>
                                            <td>
                                            <form action="/dashboard/games/{{ $game->id }}" method="POST">
                                                @csrf
                                                @method('DELETE')
