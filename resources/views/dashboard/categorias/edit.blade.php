                ...
                <div class="container-fluid">
                   ...
                   <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <div class="col-lg-7">
                                    <div class="text-center"> <h1 class="h3 mb-0 text-gray-800"><b>Modificar {{ $categoria->nome}}<br><br></b></h1></div>
                                    <div class="">
                                        <form action="/dashboard/categorias/update/{{ $categoria->id}}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-group">
                                                <label for="nome">Nome:</label>
                                                <input type="text" class="form-control form-control-user" name="nome" id="nome"
                                                 value="{{ $categoria->nome }}"   placeholder="Ação">
                                            </div>
                                            <hr>
