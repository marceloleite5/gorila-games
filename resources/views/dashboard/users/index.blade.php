...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <!-- Form de busca ##############################-->
                        <form action="/dashboard/users" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                        ...
                        <!-- Fim da busca ###############################-->
                        <a href="{{ url('/dashboard/users/create')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">

                            <i class="fas fa-download fa-sm text-white-50"></i> Novo </a>
                   ...
                   <div class="text-center">
                    ...
                    @else
                    <h1 class="h3 mb-0 text-gray-800"><b>Usuários<br><br></b></h1>
                    @endif
                </div>
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> {{ $user2->email }} </td>
                                            <td>
                                                <form action="/dashboard/users/{{ $user2->id }}" method="POST">
                                                @csrf
                                                @method('DELETE')
