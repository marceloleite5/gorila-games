...
@section('content')
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <a href="{{ url('/dashboard/users')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                   ...
                   <div class="table-responsive">
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                <div class="col-lg-7">
                                    <div class="text-center"> <h1 class="h3 mb-0 text-gray-800"><b>Adicionar novo usuário<br><br></b></h1></div>
                                    <div class="">
                                        <form action="/users" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control form-control-user" name="email" id="email"
                                                    placeholder="josedasilva@gogames.com" required>
                                            </div>
                                            <div class="form-group">
                                          ...
                                          <div class="form-group">
                                                ...
                                                <input type="password" class="form-control form-control-user" name="confirm" id="confirm" required>
                                            </div>
                                            <hr>
